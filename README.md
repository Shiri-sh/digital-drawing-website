...
* **Dual-Role Ecosystem:**
    ...
    * **Clients:** Browse original art, request custom commissions, and interact with the community.
* **Custom Commission System:** Users can upload reference images (via **Multer**), track their order status in real-time, and leave comments.
* **Secure Authentication:** Full User Sign-up/Login flow powered by **JWT** for secure, role-based access.
...
* **Context API:** Centralized state management for user sessions and cart data.
* **CSS:** Custom styling with a focus on a clean, artistic aesthetic and responsiveness.

### Backend
* **Node.js & Express:** Robust server-side logic and RESTful API architecture.
* **MySQL:** Relational database for structured storage of users, art metadata, and orders.
